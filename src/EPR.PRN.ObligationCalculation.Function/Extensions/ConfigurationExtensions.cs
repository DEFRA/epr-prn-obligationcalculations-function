...
{
	/// <summary>
	/// Loads and binds configuration sections to strongly typed options classes.
	/// </summary>
	...
	/// <summary>
	/// Adds and configures Application Insights with custom logging rules.
	/// </summary>
	...
	/// <summary>
	/// Adds and configures Azure clients, specifically the Service Bus client with DefaultAzureCredential.
	/// </summary>
	...
	/// <summary>
	///  Adds and configures HTTP clients for external services with retry policies and authorization handlers.
	/// </summary>
	...
	/// <summary>
	/// Gets a retry policy for transient HTTP errors using Polly.
	/// </summary>
